Currently, project is in early stage and HIGHLY EXPERIMENTAL. You can watch sources, but please don't run script on production servers. Using this software is on your own risk.
